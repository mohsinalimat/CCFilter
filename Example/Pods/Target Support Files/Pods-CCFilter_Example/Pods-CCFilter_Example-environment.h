...
//CNNAucFilter
#define COCOAPODS_POD_AVAILABLE_CCFilter
#define COCOAPODS_VERSION_MAJOR_CCFilter 0
#define COCOAPODS_VERSION_MINOR_CCFilter 1
#define COCOAPODS_VERSION_PATCH_CCFilter 0
